...
public final class Constants {
	...
	public static final double END_POINT_LATITUDE = 10.841205;
	public static final double END_POINT_LONGTITUDE = 106.597666;

	// icon cho map
	public static final int NODE_ICON = R.mipmap.marker_node_b;
	public static final int CONTINUE_ICON = R.mipmap.ic_continue_a;
	public static final int HERE_MARKER_ICON = R.mipmap.here3;
	public static final int DES_MARKER_ICON = R.mipmap.here2;
	public static final int BUTTON_TRACKING_ON_ICON = R.drawable.track_on;
	public static final int BUTTON_TRACKING_OFF_ICON = R.drawable.track_off;
	public static final int DEPARTURE_ICON = R.mipmap.departure;
	public static final int VIA_POINT_ICON = R.mipmap.via_point;
	public static final int DESTINATION_ICON = R.mipmap.destination;
	public static final int POI_ICON = R.mipmap.marker_poi_cluster_a;

	public static final int MARKER_POI = R.mipmap.marker_poi_a;
